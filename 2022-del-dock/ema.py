# This file is modified from one available at 
# https://github.com/fadel/pytorch_ema which is 
# copyright (c) 2019 Samuel G. Fadel and available under an MIT license
